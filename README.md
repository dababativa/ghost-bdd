...
Para ejecutar estas pruebas se debe abrir el proyecto de cypress (entrando en la carpeta cypress y ejecutando cypress open) y ejecutar los archivos, tags-a-priori.spec.js, tags-pseudo.spec.js, y tags-random.spec.js dependiendo de cual estrategia de generación de datos se quiere utilizar.
