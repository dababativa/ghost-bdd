...
describe("Tags functionalities", () => {
  ...
  it("Test create delete tag", () => {
    ...
    cy.wait(1000);
    self.tagsPage.typeTagDescription(
      "This is the description of a new tag created that will then be deleted using cypress"
    );
  ...
  it("Test create edit tag", () => {
    ...
    cy.wait(1000);
    self.tagsPage.typeTagDescription(
      "This is the description of a new tag created that has been edited using cypress"
    );
    cy.wait(1000);
    self.tagsPage.clickSaveTagButton();
  ...
  it("Test create internal tag", () => {
    ...
    cy.wait(1000);
    self.tagsPage.typeTagDescription(
      "This is the description of a new internal tag created using cypress"
    );
    cy.wait(1000);
